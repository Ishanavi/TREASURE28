class Game {
  ...
  sub1=createSprite(displayWidth - 370,150,10,10);
  sub2=createSprite(displayWidth - 370,320,10,10);
  sub3=createSprite(displayWidth - 370,480,10,10);
  sub4=createSprite(displayWidth - 370,620,10,10);
  ...
  play()
  {
    ...
    if(allPlayers !== undefined)
    {
      ...
      //x and y position of the DIVERs
      var x;
      var y = 25 ;
      ...
      for(var plr in allPlayers)
      {
        ...
        //position the DIVERs a little away from each other in x direction
        //You can change the 100 and set accordingly
        y = y + 150;
       


        //use data form the database to display the DIVERs in y direction
